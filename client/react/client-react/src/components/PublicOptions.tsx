      ...
      {notExistInPrivate ? (
        <>
          <div className="public-options-container">
            ...
            <button className="public-option-4button" onClick={() => EmailRecipe(recipe)} disabled={isAddingToPrivate}>
              <Mail size={18} />
              <span className="public-option-text">שלח למייל</span>
            </button>

            <button
              className={`public-option-4button public-favorite-button ${isAddingToPrivate ? "loading" : ""}`}
              onClick={(event) => {
                event.stopPropagation()
                handlePublicToPrivate(recipe.id)
              }}
            ...
            >
              {isAddingToPrivate ? (
                <>
                  <div className="private-button-spinner"></div>
                </>
              ) : (
                <>
                  <Book size={18} />
        ...
        <>
          <div className="public-options-container">
            ...
            <button className="public-option-button" onClick={() => EmailRecipe(recipe)} disabled={isAddingToPrivate}>
              <Mail size={18} />
              <span className="public-option-text">שלח למייל</span>
            </button>
          </div>
