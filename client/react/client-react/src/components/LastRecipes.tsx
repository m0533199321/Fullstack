                    ...
                    <div className="last-recipe-grid">
                        {recipes.map((recipe) => (
                            <div key={recipe.id} className="last-recipe-card">
                                <h3 className="last-recipe-title" style={{ fontSize: `${Math.max(0.8, 3 - recipe.title.length / 10)}em`, marginTop: '0vh' }}>{recipe.title}</h3>
                                <img src="../../images/back/recipes4.png" alt={recipe.title} className="last-recipe-image" />
                            </div>
                        ))}
                    </div>
                )}
