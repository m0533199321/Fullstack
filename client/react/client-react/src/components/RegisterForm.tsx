...
const RegisterForm = () => {
  ...
  const handleProfilePictureSelect = (file: File | null) => {
    ...
    if (file && (file as any)._isDefaultProfile) {
      ...
      console.log("RegisterForm: Using default profile URL:", defaultProfileUrl)

      // Update form data with the default profile URL
      ...
      setSnackMessage("תמונת הפרופיל נבחרה בהצלחה")
      setSnackSeverity("success")
      setSnackOpen(true)
      setTimeout(() => {
        setSnackOpen(false)
          ...
          if (presignedUrl) {
            await axios
              ...
              .then(() => {
                ...
                // Show success message
                setSnackMessage("תמונת הפרופיל הועלתה בהצלחה")
                setSnackSeverity("success")
                setSnackOpen(true)
                setTimeout(() => {
                  setSnackOpen(false)
